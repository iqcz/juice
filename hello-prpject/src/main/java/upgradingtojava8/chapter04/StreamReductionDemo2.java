...
/**
 * The demo class uses a Stream to calculate the total order value in a given month.
 * @author i324779
 *
 */
public class StreamReductionDemo2 {
    ...
    public Order[] getOrders() {
        Order[] orders = { new Order(1, 100.49, LocalDate.of(2014, Month.DECEMBER, 11)),
    ...
    public double calculateSalesTotal(Order[] orders, YearMonth yearMonth) {
        Predicate<Order> orderInGivenMonth = (
                order) -> order.orderDate.getMonth() == yearMonth.getMonth()
    ...
    public static void main(String[] args) {
        ...
        double totalSalesForMonth = demo.calculateSalesTotal(orders,
                YearMonth.of(2014, Month.NOVEMBER));
        System.out.printf("Sales for Nov 2014 : $%2.2f\n", totalSalesForMonth);

        totalSalesForMonth = demo.calculateSalesTotal(orders, YearMonth.of(2014, Month.DECEMBER));
