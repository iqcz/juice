...
<s:form action="/crud1/userUpdate.action" method="post" theme="simple">
<table width="80%" border="0" cellpadding="0" cellspacing="1" class="tableLine DoubleColorTable" >
	<tr>
    	<td colspan="4" align="center">用户修改</td>
  	</tr>
  	<tr>
    	<td>用户编号</td>
    	<td>
    		<s:textfield name="user.userId" cssClass="input" readonly="true"></s:textfield>
    	</td>
		<td>用户姓名【重点体会，不指定value】</td>
		<td>
